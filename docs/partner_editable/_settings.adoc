...
:partner-contributors: Jack Iu, Gloria Vargas, and Henry Su
:quickstart-contributors: Dave Nickles, Andrew Glenn, and Troy Ameigh, AWS Quick Start team
