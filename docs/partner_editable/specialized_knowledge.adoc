...
* Launching in Q2 2022 a new https://www.swift.com/our-solutions/interfaces-and-integration/alliance-connect-virtual[Alliance Connect Virtual^] solution is available with a CloudFormation template provided by SWIFT.
